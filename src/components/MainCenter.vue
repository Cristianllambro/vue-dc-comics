<template>
  <div class="container">
        <div class="center">
            <MainContent2 v-for="element in arrImgMain" :key="element.series" :card-series="element.series" :card-img="element.thumb" />
        </div>
...
<script>
import MainContent2 from './MainContent2.vue'
...
.container{
    width: 100%;
    background-color: $color_bk_dark;
}
.center{
    width: 1200px;
    margin: 0 auto;
